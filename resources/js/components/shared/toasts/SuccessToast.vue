...
<script>
    export default {
        ...
        methods: {
            getMessage() {
                if (this.$parent.$parent.$refs.brands.successMessage !== null) {
                   this.success = this.$parent.$parent.$refs.brands.successMessage
                   setTimeout( () => this.success = null , 3000)
                }
            },
            getClientsMessage() {
                if (this.$parent.$parent.$refs.clients.successMessage !== null) {
                    this.success = this.$parent.$parent.$refs.clients.successMessage
                    setTimeout( () => this.success = null , 3000)
                }
            },
            getProductsMessage() {
                if (this.$parent.$parent.$refs.products.successMessage !== null) {
                    this.success = this.$parent.$parent.$refs.products.successMessage
                    setTimeout( () => this.success = null , 3000)
                }
            },
            getOrdersMessage() {
                if (this.$parent.$parent.$refs.orders.successMessage !== null) {
                    this.success = this.$parent.$parent.$refs.orders.successMessage
                    setTimeout( () => this.success = null , 3000)
                }
            },
