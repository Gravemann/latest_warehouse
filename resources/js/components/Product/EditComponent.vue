            ...
            <div class="flex-col">
                <form @submit.prevent="update(id)">
                    ...
                    <select v-model="brand_id"
                        ...
                        <option v-if="brand_id == null" class="text-slate-200" :value="null" selected disabled hidden>Please select the brand</option>
...
<script>
    export default {
        ...
        methods: {
            changeUpdateProductId(id, brand_id, name, purchase_price, sale_price, quantity, image) {
                axios.get('api/all', {
                    headers: {
